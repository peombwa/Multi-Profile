...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/get-mgusersmailusermailfoldermessagerule
schema: 2.0.0
---

# Get-MgUsersMailUserMailFolderMessageRule
...
### List (Default)
```
Get-MgUsersMailUserMailFolderMessageRule -MailFolderId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgUsersMailUserMailFolderMessageRule -MailFolderId <String> -MessageRuleId <String> -UserId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUsersMailUserMailFolderMessageRule -InputObject <IUsersMailIdentity> [-Expand <String[]>]
