...
### Create
```
New-MgUsersMailUserMessage -UserId <String> -BodyParameter <IMicrosoftGraphMessage1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgUsersMailUserMessage -InputObject <IUsersMailIdentity> -BodyParameter <IMicrosoftGraphMessage1>
