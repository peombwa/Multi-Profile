...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/update-mgusersmailusermailfoldermessagemention
schema: 2.0.0
---

# Update-MgUsersMailUserMailFolderMessageMention
...
```
Update-MgUsersMailUserMailFolderMessageMention -MailFolderId <String> -MentionId <String> -MessageId <String>
...
### UpdateViaIdentity
```
Update-MgUsersMailUserMailFolderMessageMention -InputObject <IUsersMailIdentity>
 -BodyParameter <IMicrosoftGraphMention> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUsersMailUserMailFolderMessageMention -InputObject <IUsersMailIdentity> [-Application <String>]
