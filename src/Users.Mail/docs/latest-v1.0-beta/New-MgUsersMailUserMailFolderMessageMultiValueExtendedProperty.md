...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/new-mgusersmailusermailfoldermessagemultivalueextendedproperty
schema: 2.0.0
---

# New-MgUsersMailUserMailFolderMessageMultiValueExtendedProperty
...
```
New-MgUsersMailUserMailFolderMessageMultiValueExtendedProperty -MailFolderId <String> -MessageId <String>
...
```
New-MgUsersMailUserMailFolderMessageMultiValueExtendedProperty -MailFolderId <String> -MessageId <String>
 -UserId <String> -BodyParameter <IMicrosoftGraphMultiValueLegacyExtendedProperty> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgUsersMailUserMailFolderMessageMultiValueExtendedProperty -InputObject <IUsersMailIdentity>
