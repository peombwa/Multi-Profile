...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/update-mgusersmailusermessageattachment
schema: 2.0.0
---

# Update-MgUsersMailUserMessageAttachment
...
```
Update-MgUsersMailUserMessageAttachment -AttachmentId <String> -MessageId <String> -UserId <String>
...
### UpdateViaIdentity1
```
Update-MgUsersMailUserMessageAttachment -InputObject <IUsersMailIdentity>
 -BodyParameter <IMicrosoftGraphAttachment> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgUsersMailUserMessageAttachment -InputObject <IUsersMailIdentity> [-ContentType <String>]
