...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/update-mgusersmailusermessagemention
schema: 2.0.0
---

# Update-MgUsersMailUserMessageMention
...
```
Update-MgUsersMailUserMessageMention -MentionId <String> -MessageId <String> -UserId <String>
...
### UpdateViaIdentity
```
Update-MgUsersMailUserMessageMention -InputObject <IUsersMailIdentity> -BodyParameter <IMicrosoftGraphMention>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUsersMailUserMessageMention -InputObject <IUsersMailIdentity> [-Application <String>]
