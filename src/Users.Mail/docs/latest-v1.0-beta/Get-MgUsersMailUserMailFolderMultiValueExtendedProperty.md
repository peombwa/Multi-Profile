...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/get-mgusersmailusermailfoldermultivalueextendedproperty
schema: 2.0.0
---

# Get-MgUsersMailUserMailFolderMultiValueExtendedProperty
...
### List (Default)
```
Get-MgUsersMailUserMailFolderMultiValueExtendedProperty -MailFolderId <String> -UserId <String> [-Count]
...
### Get
```
Get-MgUsersMailUserMailFolderMultiValueExtendedProperty -MailFolderId <String>
...
### GetViaIdentity
```
Get-MgUsersMailUserMailFolderMultiValueExtendedProperty -InputObject <IUsersMailIdentity> [-Expand <String[]>]
