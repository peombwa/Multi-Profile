...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/get-mgusersmailusermailfoldermessagemention
schema: 2.0.0
---

# Get-MgUsersMailUserMailFolderMessageMention
...
### List (Default)
```
Get-MgUsersMailUserMailFolderMessageMention -MailFolderId <String> -MessageId <String> -UserId <String>
...
### Get
```
Get-MgUsersMailUserMailFolderMessageMention -MailFolderId <String> -MentionId <String> -MessageId <String>
 -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUsersMailUserMailFolderMessageMention -InputObject <IUsersMailIdentity> [-Expand <String[]>]
...
### Microsoft.Graph.PowerShell.Cmdlets.UsersMail.Models.IMicrosoftGraphMention
