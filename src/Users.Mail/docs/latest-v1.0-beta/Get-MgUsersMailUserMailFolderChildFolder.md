...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/get-mgusersmailusermailfolderchildfolder
schema: 2.0.0
---

# Get-MgUsersMailUserMailFolderChildFolder
...
### List1 (Default)
```
Get-MgUsersMailUserMailFolderChildFolder -MailFolderId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### Get1
```
Get-MgUsersMailUserMailFolderChildFolder -MailFolderId <String> -MailFolderId1 <String> -UserId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgUsersMailUserMailFolderChildFolder -InputObject <IUsersMailIdentity> [-Expand <String[]>]
