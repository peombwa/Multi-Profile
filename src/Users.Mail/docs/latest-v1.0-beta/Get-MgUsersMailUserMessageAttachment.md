...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/get-mgusersmailusermessageattachment
schema: 2.0.0
---

# Get-MgUsersMailUserMessageAttachment
...
### List (Default)
```
Get-MgUsersMailUserMessageAttachment -MessageId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgUsersMailUserMessageAttachment -AttachmentId <String> -MessageId <String> -UserId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUsersMailUserMessageAttachment -InputObject <IUsersMailIdentity> [-Expand <String[]>]
