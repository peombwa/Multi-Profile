...
### List1 (Default)
```
Get-MgUsersMailUserMailFolderMessageRule -MailFolderId <String> -UserId <String> [-Count] [-Filter <String>]
...
### GetViaIdentity1
```
Get-MgUsersMailUserMailFolderMessageRule -InputObject <IUsersMailIdentity> [-Select <String[]>]
 [<CommonParameters>]
```
