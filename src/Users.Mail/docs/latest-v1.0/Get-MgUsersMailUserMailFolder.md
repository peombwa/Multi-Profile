...
### List (Default)
```
Get-MgUsersMailUserMailFolder -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get1
```
Get-MgUsersMailUserMailFolder -MailFolderId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgUsersMailUserMailFolder -InputObject <IUsersMailIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
