...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/update-mgusersmailusermailfoldermessagerule
schema: 2.0.0
---

# Update-MgUsersMailUserMailFolderMessageRule
...
```
Update-MgUsersMailUserMailFolderMessageRule -MailFolderId <String> -MessageRuleId <String> -UserId <String>
 [-ActionAssignCategories <String[]>] [-ActionCopyToFolder <String>] [-ActionDelete]
 [-ActionForwardAsAttachmentTo <IMicrosoftGraphRecipient[]>] [-ActionForwardTo <IMicrosoftGraphRecipient[]>]
 [-ActionMarkAsRead] [-ActionMarkImportance <String>] [-ActionMoveToFolder <String>] [-ActionPermanentDelete]
 [-ActionRedirectTo <IMicrosoftGraphRecipient[]>] [-ActionStopProcessingRules]
...
### UpdateViaIdentity
```
Update-MgUsersMailUserMailFolderMessageRule -InputObject <IUsersMailIdentity>
 -BodyParameter <IMicrosoftGraphMessageRule> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### -ActionForwardAsAttachmentTo
The email addresses of the recipients to which a message should be forwarded as an attachment.
To construct, see NOTES section for ACTIONFORWARDASATTACHMENTTO properties and create a hash table.
...
To construct, see NOTES section for ACTIONFORWARDTO properties and create a hash table.
...
To construct, see NOTES section for ACTIONREDIRECTTO properties and create a hash table.
...
```yaml
Type: Microsoft.Graph.PowerShell.Cmdlets.UsersMail.Models.IMicrosoftGraphMessageRulePredicates
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:
...
### -MessageRuleId
key: messageRule-id of messageRule
...
### Microsoft.Graph.PowerShell.Cmdlets.UsersMail.Models.IMicrosoftGraphMessageRule
