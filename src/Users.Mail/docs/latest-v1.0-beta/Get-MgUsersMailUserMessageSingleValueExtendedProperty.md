...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/get-mgusersmailusermessagesinglevalueextendedproperty
schema: 2.0.0
---

# Get-MgUsersMailUserMessageSingleValueExtendedProperty
...
### List (Default)
```
Get-MgUsersMailUserMessageSingleValueExtendedProperty -MessageId <String> -UserId <String> [-Count]
...
### Get
```
Get-MgUsersMailUserMessageSingleValueExtendedProperty -MessageId <String>
...
### GetViaIdentity
```
Get-MgUsersMailUserMessageSingleValueExtendedProperty -InputObject <IUsersMailIdentity> [-Expand <String[]>]
