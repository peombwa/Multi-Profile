...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/get-mgusersmailusermessageextension
schema: 2.0.0
---

# Get-MgUsersMailUserMessageExtension
...
### List1 (Default)
```
Get-MgUsersMailUserMessageExtension -MessageId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### Get1
```
Get-MgUsersMailUserMessageExtension -ExtensionId <String> -MessageId <String> -UserId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgUsersMailUserMessageExtension -InputObject <IUsersMailIdentity> [-Expand <String[]>]
