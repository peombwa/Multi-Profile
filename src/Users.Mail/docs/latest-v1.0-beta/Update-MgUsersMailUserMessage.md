...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/update-mgusersmailusermessage
schema: 2.0.0
---

# Update-MgUsersMailUserMessage
...
```
Update-MgUsersMailUserMessage -MessageId <String> -UserId <String>
...
### Update
```
Update-MgUsersMailUserMessage -MessageId <String> -UserId <String> -BodyParameter <IMicrosoftGraphMessage>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgUsersMailUserMessage -InputObject <IUsersMailIdentity> -BodyParameter <IMicrosoftGraphMessage>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUsersMailUserMessage -InputObject <IUsersMailIdentity> [-Attachments <IMicrosoftGraphAttachment[]>]
