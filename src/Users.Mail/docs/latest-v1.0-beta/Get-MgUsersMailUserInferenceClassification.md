...
### Get1 (Default)
```
Get-MgUsersMailUserInferenceClassification -UserId <String> [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgUsersMailUserInferenceClassification -InputObject <IUsersMailIdentity> [-Select <String[]>]
 [<CommonParameters>]
```
