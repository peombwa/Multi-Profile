...
### List1 (Default)
```
Get-MgUsersMailUserMessage -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get1
```
Get-MgUsersMailUserMessage -MessageId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgUsersMailUserMessage -InputObject <IUsersMailIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
