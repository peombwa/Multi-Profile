...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/update-mgusersmailusermessagemultivalueextendedproperty
schema: 2.0.0
---

# Update-MgUsersMailUserMessageMultiValueExtendedProperty
...
```
Update-MgUsersMailUserMessageMultiValueExtendedProperty -MessageId <String>
...
### UpdateViaIdentity1
```
Update-MgUsersMailUserMessageMultiValueExtendedProperty -InputObject <IUsersMailIdentity>
 -BodyParameter <IMicrosoftGraphMultiValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgUsersMailUserMessageMultiValueExtendedProperty -InputObject <IUsersMailIdentity> [-Id <String>]
