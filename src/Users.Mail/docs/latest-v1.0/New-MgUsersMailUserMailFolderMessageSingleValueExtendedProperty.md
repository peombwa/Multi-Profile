...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/new-mgusersmailusermailfoldermessagesinglevalueextendedproperty
schema: 2.0.0
---

# New-MgUsersMailUserMailFolderMessageSingleValueExtendedProperty
...
```
New-MgUsersMailUserMailFolderMessageSingleValueExtendedProperty -MailFolderId <String> -MessageId <String>
...
### CreateViaIdentity1
```
New-MgUsersMailUserMailFolderMessageSingleValueExtendedProperty -InputObject <IUsersMailIdentity>
