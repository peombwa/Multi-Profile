...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/update-mgusersmailusermessagesinglevalueextendedproperty
schema: 2.0.0
---

# Update-MgUsersMailUserMessageSingleValueExtendedProperty
...
```
Update-MgUsersMailUserMessageSingleValueExtendedProperty -MessageId <String>
...
### UpdateViaIdentity
```
Update-MgUsersMailUserMessageSingleValueExtendedProperty -InputObject <IUsersMailIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgUsersMailUserMessageSingleValueExtendedProperty -InputObject <IUsersMailIdentity> [-Id <String>]
