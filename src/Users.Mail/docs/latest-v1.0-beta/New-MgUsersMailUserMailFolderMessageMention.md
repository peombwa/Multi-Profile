...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/new-mgusersmailusermailfoldermessagemention
schema: 2.0.0
---

# New-MgUsersMailUserMailFolderMessageMention
...
```
New-MgUsersMailUserMailFolderMessageMention -MailFolderId <String> -MessageId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgUsersMailUserMailFolderMessageMention -InputObject <IUsersMailIdentity>
 -BodyParameter <IMicrosoftGraphMention> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUsersMailUserMailFolderMessageMention -InputObject <IUsersMailIdentity> [-Application <String>]
