...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/update-mgusersmailuserinferenceclassification
schema: 2.0.0
---

# Update-MgUsersMailUserInferenceClassification
...
```
Update-MgUsersMailUserInferenceClassification -UserId <String> [-Id <String>]
...
### Update1
```
Update-MgUsersMailUserInferenceClassification -UserId <String>
 -BodyParameter <IMicrosoftGraphInferenceClassification> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgUsersMailUserInferenceClassification -InputObject <IUsersMailIdentity>
 -BodyParameter <IMicrosoftGraphInferenceClassification> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgUsersMailUserInferenceClassification -InputObject <IUsersMailIdentity> [-Id <String>]
 [-Overrides <IMicrosoftGraphInferenceClassificationOverride[]>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Cmdlets.UsersMail.Models.IMicrosoftGraphInferenceClassification
...
BODYPARAMETER <IMicrosoftGraphInferenceClassification>: inferenceClassification
  - `[Id <String>]`: Read-only.
  - `[Overrides <IMicrosoftGraphInferenceClassificationOverride[]>]`: 
    - `[Id <String>]`: Read-only.
