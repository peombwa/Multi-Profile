...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/get-mgusersmailusermessage
schema: 2.0.0
---

# Get-MgUsersMailUserMessage
...
### List (Default)
```
Get-MgUsersMailUserMessage -UserId <String> [-Count] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgUsersMailUserMessage -MessageId <String> -UserId <String> [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUsersMailUserMessage -InputObject <IUsersMailIdentity> [-Select <String[]>] [<CommonParameters>]
```
