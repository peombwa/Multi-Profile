...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/new-mgusersmailusermessagemention
schema: 2.0.0
---

# New-MgUsersMailUserMessageMention
...
```
New-MgUsersMailUserMessageMention -MessageId <String> -UserId <String> [-Application <String>]
...
### Create
```
New-MgUsersMailUserMessageMention -MessageId <String> -UserId <String> -BodyParameter <IMicrosoftGraphMention>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgUsersMailUserMessageMention -InputObject <IUsersMailIdentity> -BodyParameter <IMicrosoftGraphMention>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUsersMailUserMessageMention -InputObject <IUsersMailIdentity> [-Application <String>]
 [-ClientReference <String>] [-CreatedByAddress <String>] [-CreatedByName <String>]
 [-CreatedDateTime <DateTime>] [-DeepLink <String>] [-Id <String>] [-MentionedAddress <String>]
 [-MentionedName <String>] [-MentionText <String>] [-ServerCreatedDateTime <DateTime>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
