...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/new-mgusersmailusermessageextension
schema: 2.0.0
---

# New-MgUsersMailUserMessageExtension
...
```
New-MgUsersMailUserMessageExtension -MessageId <String> -UserId <String> [-Id <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgUsersMailUserMessageExtension -MessageId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphExtension> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgUsersMailUserMessageExtension -InputObject <IUsersMailIdentity>
 -BodyParameter <IMicrosoftGraphExtension> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUsersMailUserMessageExtension -InputObject <IUsersMailIdentity> [-Id <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
