...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/new-mgusersmailusermessage
schema: 2.0.0
---

# New-MgUsersMailUserMessage
...
```
New-MgUsersMailUserMessage -UserId <String> [-Attachments <IMicrosoftGraphAttachment[]>]
 ...
 [-FlagStatus <String>] [-FromEmailAddressAddress <String>] [-FromEmailAddressName <String>] [-HasAttachments]
...
### Create1
```
New-MgUsersMailUserMessage -UserId <String> -BodyParameter <IMicrosoftGraphMessage> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgUsersMailUserMessage -InputObject <IUsersMailIdentity> -BodyParameter <IMicrosoftGraphMessage>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgUsersMailUserMessage -InputObject <IUsersMailIdentity> [-Attachments <IMicrosoftGraphAttachment[]>]
 [-BccRecipients <IMicrosoftGraphRecipient[]>] [-BodyContent <String>] [-BodyContentType <String>]
 [-BodyPreview <String>] [-Categories <String[]>] [-CcRecipients <IMicrosoftGraphRecipient[]>]
 [-ChangeKey <String>] [-CompletedDateTime <String>] [-CompletedDateTimeZone <String>]
 [-ConversationId <String>] [-ConversationIndexInputFile <String>] [-CreatedDateTime <DateTime>]
...
### Microsoft.Graph.PowerShell.Cmdlets.UsersMail.Models.IMicrosoftGraphMessage
