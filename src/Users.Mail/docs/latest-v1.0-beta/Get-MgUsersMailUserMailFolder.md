...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/get-mgusersmailusermailfolder
schema: 2.0.0
---

# Get-MgUsersMailUserMailFolder
...
### List1 (Default)
```
Get-MgUsersMailUserMailFolder -UserId <String> [-Count] [-Filter <String>] [-Orderby <String[]>]
 [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgUsersMailUserMailFolder -MailFolderId <String> -UserId <String> [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUsersMailUserMailFolder -InputObject <IUsersMailIdentity> [-Select <String[]>] [<CommonParameters>]
```
