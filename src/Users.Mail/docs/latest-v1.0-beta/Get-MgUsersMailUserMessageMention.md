...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/get-mgusersmailusermessagemention
schema: 2.0.0
---

# Get-MgUsersMailUserMessageMention
...
### List (Default)
```
Get-MgUsersMailUserMessageMention -MessageId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgUsersMailUserMessageMention -MentionId <String> -MessageId <String> -UserId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUsersMailUserMessageMention -InputObject <IUsersMailIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
