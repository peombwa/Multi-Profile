...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/new-mgusersmailusermailfoldermessagerule
schema: 2.0.0
---

# New-MgUsersMailUserMailFolderMessageRule
...
```
New-MgUsersMailUserMailFolderMessageRule -MailFolderId <String> -UserId <String>
...
### CreateViaIdentity1
```
New-MgUsersMailUserMailFolderMessageRule -InputObject <IUsersMailIdentity>
 -BodyParameter <IMicrosoftGraphMessageRule> [-Confirm] [-WhatIf] [<CommonParameters>]
```
