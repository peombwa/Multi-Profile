...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/get-mgusersmailusermailfoldermessage
schema: 2.0.0
---

# Get-MgUsersMailUserMailFolderMessage
...
### List (Default)
```
Get-MgUsersMailUserMailFolderMessage -MailFolderId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgUsersMailUserMailFolderMessage -MailFolderId <String> -MessageId <String> -UserId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUsersMailUserMailFolderMessage -InputObject <IUsersMailIdentity> [-Expand <String[]>]
