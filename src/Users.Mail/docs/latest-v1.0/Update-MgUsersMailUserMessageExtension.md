...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/update-mgusersmailusermessageextension
schema: 2.0.0
---

# Update-MgUsersMailUserMessageExtension
...
```
Update-MgUsersMailUserMessageExtension -ExtensionId <String> -MessageId <String> -UserId <String>
...
### UpdateViaIdentity1
```
Update-MgUsersMailUserMessageExtension -InputObject <IUsersMailIdentity>
 -BodyParameter <IMicrosoftGraphExtension> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgUsersMailUserMessageExtension -InputObject <IUsersMailIdentity> [-Id <String>] [-PassThru] [-Confirm]
