...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/new-mgusersmailusermailfolderuserconfiguration
schema: 2.0.0
---

# New-MgUsersMailUserMailFolderUserConfiguration
...
```
New-MgUsersMailUserMailFolderUserConfiguration -MailFolderId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgUsersMailUserMailFolderUserConfiguration -InputObject <IUsersMailIdentity>
 -BodyParameter <IMicrosoftGraphUserConfiguration> [-Confirm] [-WhatIf] [<CommonParameters>]
```
