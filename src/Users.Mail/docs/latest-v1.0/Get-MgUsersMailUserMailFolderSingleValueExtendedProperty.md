...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/get-mgusersmailusermailfoldersinglevalueextendedproperty
schema: 2.0.0
---

# Get-MgUsersMailUserMailFolderSingleValueExtendedProperty
...
### List1 (Default)
```
Get-MgUsersMailUserMailFolderSingleValueExtendedProperty -MailFolderId <String> -UserId <String> [-Count]
...
### Get1
```
Get-MgUsersMailUserMailFolderSingleValueExtendedProperty -MailFolderId <String>
...
### GetViaIdentity1
```
Get-MgUsersMailUserMailFolderSingleValueExtendedProperty -InputObject <IUsersMailIdentity>
