...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/get-mgusersmailusermailfoldermessagemultivalueextendedproperty
schema: 2.0.0
---

# Get-MgUsersMailUserMailFolderMessageMultiValueExtendedProperty
...
### List1 (Default)
```
Get-MgUsersMailUserMailFolderMessageMultiValueExtendedProperty -MailFolderId <String> -MessageId <String>
...
### GetViaIdentity1
```
Get-MgUsersMailUserMailFolderMessageMultiValueExtendedProperty -InputObject <IUsersMailIdentity>
