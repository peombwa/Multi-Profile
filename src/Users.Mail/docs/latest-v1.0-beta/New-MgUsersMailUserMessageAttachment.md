...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/new-mgusersmailusermessageattachment
schema: 2.0.0
---

# New-MgUsersMailUserMessageAttachment
...
```
New-MgUsersMailUserMessageAttachment -MessageId <String> -UserId <String> [-ContentType <String>]
...
### Create
```
New-MgUsersMailUserMessageAttachment -MessageId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphAttachment> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgUsersMailUserMessageAttachment -InputObject <IUsersMailIdentity>
 -BodyParameter <IMicrosoftGraphAttachment> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUsersMailUserMessageAttachment -InputObject <IUsersMailIdentity> [-ContentType <String>] [-Id <String>]
