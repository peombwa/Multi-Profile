...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/update-mgusersmailusermailfolderuserconfiguration
schema: 2.0.0
---

# Update-MgUsersMailUserMailFolderUserConfiguration
...
```
Update-MgUsersMailUserMailFolderUserConfiguration -MailFolderId <String> -UserConfigurationId <String>
 -UserId <String> [-BinaryDataInputFile <String>] [-Id <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgUsersMailUserMailFolderUserConfiguration -MailFolderId <String> -UserConfigurationId <String>
 -UserId <String> -BodyParameter <IMicrosoftGraphUserConfiguration> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgUsersMailUserMailFolderUserConfiguration -InputObject <IUsersMailIdentity>
...
### Microsoft.Graph.PowerShell.Cmdlets.UsersMail.Models.IMicrosoftGraphUserConfiguration
