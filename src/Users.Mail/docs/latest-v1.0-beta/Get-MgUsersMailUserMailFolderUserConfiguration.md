...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/get-mgusersmailusermailfolderuserconfiguration
schema: 2.0.0
---

# Get-MgUsersMailUserMailFolderUserConfiguration
...
### List (Default)
```
Get-MgUsersMailUserMailFolderUserConfiguration -MailFolderId <String> -UserId <String> [-Count]
...
### Get
```
Get-MgUsersMailUserMailFolderUserConfiguration -MailFolderId <String> -UserConfigurationId <String>
 -UserId <String> [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUsersMailUserMailFolderUserConfiguration -InputObject <IUsersMailIdentity> [-Select <String[]>]
 [<CommonParameters>]
```
