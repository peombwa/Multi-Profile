...
online version: https://docs.microsoft.com/en-us/powershell/module/mg.usersmail/update-mgusersmailusermailfoldermultivalueextendedproperty
schema: 2.0.0
---

# Update-MgUsersMailUserMailFolderMultiValueExtendedProperty
...
```
Update-MgUsersMailUserMailFolderMultiValueExtendedProperty -MailFolderId <String>
...
### UpdateViaIdentity
```
Update-MgUsersMailUserMailFolderMultiValueExtendedProperty -InputObject <IUsersMailIdentity>
 -BodyParameter <IMicrosoftGraphMultiValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgUsersMailUserMailFolderMultiValueExtendedProperty -InputObject <IUsersMailIdentity> [-Id <String>]
